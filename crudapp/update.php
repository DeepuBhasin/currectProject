...
if (isset($_GET['id'])) {
    if (!empty($_POST)) {
        ...
        $brands = isset($_POST['id']) ? $_POST['name'] : NULL;
        $models = isset($_POST['id']) ? $_POST['name'] : '';
        $sizes = isset($_POST['id']) ? $_POST['name'] : '';
        
        // Update the record
        $stmt = $pdo->prepare('UPDATE brands SET id = ?, name = ?, email = ?, phone = ?, title = ?, created = ? WHERE id = ?');
